...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_MTU, 74);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 80);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_UBX_EVKNORAB10_NRF5340_CPUAPP, 1);
